...
/*
				...
				item.add(new Label("linkSubjectStudy.ageAtEnrollment", Integer.toString(subject.getAgeAtEnrollment())));
...
*/
				...
				item.add(new Label("linkSubjectStudy.ageAtEnrollment", String.valueOf(subject.getAgeAtEnrollment())));
