...
@Service("redcapRecordImporterService")
public class RedcapRecordImporterServiceImpl extends TimerTask implements IRedcapRecordImporterService{
	
	protected transient Logger		log					= LoggerFactory.getLogger(RedcapRecordImporterServiceImpl.class);
