 ...
 * 
 */
public class AdminVO extends RedcapVO implements Serializable {
	...
	public AdminVO() {
		...
		this.setAvailableArkFunctions(new ArrayList<ArkFunction>(0));
		this.setSelectedArkRoles(new ArrayList<ArkRole>(0));
		this.setAvailableArkRoles(new ArrayList<ArkRole>(0));
	}
	...
	/**
	 * @param arkModuleRole the arkModuleRole to set
	 */
	public void setArkModuleRole(ArkModuleRole arkModuleRole) {
		this.arkModuleRole = arkModuleRole;
	}

	/**
	 * @return the arkModuleRole
	 */
	public ArkModuleRole getArkModuleRole() {
		return arkModuleRole;
	}
